...
class Norma extends BaseClass {
	...
	/**
	 * @Vich\UploadableField(mapping="normas", fileNameProperty="id")
	 * @var File
	 */
	...
	/**
	 * @ORM\OneToMany(targetEntity="AnexoNorma", mappedBy="norma")
	 */
	private $anexos;

	/**
	 * @ORM\OneToMany(targetEntity="App\Entity\BeneficiarioNorma", mappedBy="norma", orphanRemoval=true)
	 */
	private $beneficiarioNormas;

	/**
	 * @ORM\OneToMany(targetEntity="App\Entity\PalabraClaveNorma", mappedBy="norma", orphanRemoval=true)
	 */
	private $palabrasClaveNorma;

	/**
	 * @ORM\OneToMany(targetEntity="App\Entity\DescriptorNorma", mappedBy="norma", orphanRemoval=true)
	 */
	private $descriptoresNorma;

	/**
	 * @ORM\OneToMany(targetEntity="App\Entity\IdentificadorNorma", mappedBy="norma", orphanRemoval=true)
	 */
