...
/**
 * @ORM\Entity(repositoryClass="App\Repository\AnexoOriginalRepository")
 * @Vich\Uploadable
 */
class AnexoOriginalNorma extends BaseClass {
	/**
	 * @ORM\Id()
	 * @ORM\GeneratedValue()
    ...
    /**
	 * @Vich\UploadableField(mapping="anexos_originales", fileNameProperty="archivo")
	 * @var File
	 */
	...
	/**
	 * @ORM\ManyToOne(targetEntity="App\Entity\Norma", inversedBy="anexosOriginales")
	 */
	private $norma;
